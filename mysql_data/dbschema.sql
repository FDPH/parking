...
START TRANSACTION;
USE `parking`;
INSERT INTO `parking`.`parking_slots` (`id`, `slot_number`, `type`, `update_at`, `is_available`) VALUES (DEFAULT, 'M1', 'MOTORCYCLE', CURRENT_TIMESTAMP, 1);
INSERT INTO `parking`.`parking_slots` (`id`, `slot_number`, `type`, `update_at`, `is_available`) VALUES (DEFAULT, 'M2', 'MOTORCYCLE', CURRENT_TIMESTAMP, 1);
INSERT INTO `parking`.`parking_slots` (`id`, `slot_number`, `type`, `update_at`, `is_available`) VALUES (DEFAULT, 'M3', 'MOTORCYCLE', CURRENT_TIMESTAMP, 1);
INSERT INTO `parking`.`parking_slots` (`id`, `slot_number`, `type`, `update_at`, `is_available`) VALUES (DEFAULT, 'M4', 'MOTORCYCLE', CURRENT_TIMESTAMP, 1);
INSERT INTO `parking`.`parking_slots` (`id`, `slot_number`, `type`, `update_at`, `is_available`) VALUES (DEFAULT, 'M5', 'MOTORCYCLE', CURRENT_TIMESTAMP, 1);
INSERT INTO `parking`.`parking_slots` (`id`, `slot_number`, `type`, `update_at`, `is_available`) VALUES (DEFAULT, 'M6', 'MOTORCYCLE', CURRENT_TIMESTAMP, 1);
INSERT INTO `parking`.`parking_slots` (`id`, `slot_number`, `type`, `update_at`, `is_available`) VALUES (DEFAULT, 'V1', 'CAR', CURRENT_TIMESTAMP, 1);
INSERT INTO `parking`.`parking_slots` (`id`, `slot_number`, `type`, `update_at`, `is_available`) VALUES (DEFAULT, 'V2', 'CAR', CURRENT_TIMESTAMP, 1);
INSERT INTO `parking`.`parking_slots` (`id`, `slot_number`, `type`, `update_at`, `is_available`) VALUES (DEFAULT, 'V3', 'CAR', CURRENT_TIMESTAMP, 1);
INSERT INTO `parking`.`parking_slots` (`id`, `slot_number`, `type`, `update_at`, `is_available`) VALUES (DEFAULT, 'V4', 'CAR', CURRENT_TIMESTAMP, 1);
INSERT INTO `parking`.`parking_slots` (`id`, `slot_number`, `type`, `update_at`, `is_available`) VALUES (DEFAULT, 'V5', 'CAR', CURRENT_TIMESTAMP, 1);
